...
// MatrixProx
Eigen::MatrixXd MatrixProx(const Eigen::MatrixXd& X, double lambda, const Eigen::VectorXd& weights, bool l1);
RcppExport SEXP _clustRviz_MatrixProx(SEXP XSEXP, SEXP lambdaSEXP, SEXP weightsSEXP, SEXP l1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type X(XSEXP);
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type weights(weightsSEXP);
    Rcpp::traits::input_parameter< bool >::type l1(l1SEXP);
    rcpp_result_gen = Rcpp::wrap(MatrixProx(X, lambda, weights, l1));
    return rcpp_result_gen;
END_RCPP
}
// check_weight_matrix
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_clustRviz_MatrixProx", (DL_FUNC) &_clustRviz_MatrixProx, 4},
